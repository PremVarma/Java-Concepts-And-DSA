...
public class ConcurrentHashmapExample {
    // Shared ConcurrentHashMap for page visitor counts
    private static final ConcurrentHashMap<String, Integer> visitorCounts = new ConcurrentHashMap<>();
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // ConcurrentHashMap-specific: forEach
        System.out.print("Page counts (forEach): ");
        visitorCounts.forEach((page, count) -> System.out.print(page + "=" + count + ", "));
        System.out.println();
    }
